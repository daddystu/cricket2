...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { batting: @point.batting, bowling: @point.bowling, match: @point.match, match_id: @point.match_id, team_id: @point.team_id }
    end
  ...
  test "should update point" do
    put :update, id: @point, point: { batting: @point.batting, bowling: @point.bowling, match: @point.match, match_id: @point.match_id, team_id: @point.team_id }
    assert_redirected_to point_path(assigns(:point))
  end
